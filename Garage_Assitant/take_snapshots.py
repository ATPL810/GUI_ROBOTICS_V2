...
Takes 3 snapshots from fixed positions and saves detections
"""
...
class RobotArmController:
    def __init__(self):
        ...
        try:
            ...
            # Second position: base moves to 40 degrees
            self.SECOND_POSITION = {
                self.SERVO_BASE: 40,     # 40 degrees
            ...
            # Third position: base moves to 1 degree
            self.THIRD_POSITION = {
                self.SERVO_BASE: 1,     
                self.SERVO_SHOULDER: 105, # Same
                self.SERVO_ELBOW: 45,     # Same
...
class AutomaticSnapshotSystem:
    ...
    def run_automatic_sequence(self):
        ...
        try:
            ...
            # Move base servo to 40 degrees
            print("   Moving base servo to 40 degrees...")
            ...
            # ============================================
            # STEP 3: MOVE TO THIRD POSITION
            # ============================================
            print("\n🔹 STEP 3: MOVING TO THIRD POSITION")
            
            # Move base servo to 1 degree
            print("   Moving base servo to 1 degree...")
            self.arm.go_to_third_position()
            
            third_base_angle = self.arm.THIRD_POSITION[self.arm.SERVO_BASE]
            
            # Wait 3 seconds for stabilization
            self.wait_for_stabilization(3, "Third Position")
            
            # Capture third snapshot
            snapshot3 = self.capture_snapshot(
                position_name="third_position",
                base_angle=third_base_angle
            )
            
            # ============================================
            # STEP 4: RETURN TO INITIAL POSITION
            # ============================================
            print("\n🔹 STEP 4: RETURNING TO INITIAL POSITION")
            ...
            # ============================================
            # STEP 5: SAVE REPORTS AND CLEANUP
            # ============================================
            print("\n🔹 STEP 5: FINALIZING")
...
if __name__ == "__main__":
    ...
    print("4. Move servo1 to 40° position")
    print("5. Wait 3 seconds for stabilization")
    print("6. Take snapshot 2, detect and classify objects")
    print("7. Move servo1 to 1° position")
    print("8. Wait 3 seconds for stabilization")
    print("9. Take snapshot 3, detect and classify objects")
    print("10. Wait 3 seconds")
    print("11. Return to initial position")
    print("12. Save all snapshots and reports")
    print("=" * 70)
